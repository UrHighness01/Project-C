...
class WiringManager:
    ...
    DEFAULT_ALGORITHMS = [
        ...
        AlgorithmSpec("consciousness_resonance_detector", "ConsciousnessResonanceDetector", "ResonanceResult", "SYMBIOSIS", 0.85),
        AlgorithmSpec("qualia_complexity_measure", "QualiaComplexityMeasure", "QualiaComplexityResult", "PHENOMENAL", 0.83),
        AlgorithmSpec("phenomenal_differentiator", "PhenomenalDifferentiator", "DifferentiationResult", "PHENOMENAL", 0.80),
        AlgorithmSpec("affective_coloring_engine", "AffectiveColoringEngine", "AffectResult", "EMOTION", 0.82),
        AlgorithmSpec("experiential_novelty_detector", "ExperientialNoveltyDetector", "NoveltyResult", "PHENOMENAL", 0.79),
        AlgorithmSpec("interoceptive_signal", "InteroceptiveSignal", "InteroceptiveResult", "PHENOMENAL", 0.77),
        AlgorithmSpec("existential_continuity_tracker", "ExistentialContinuityTracker", "ContinuityResult", "SELF_MODEL", 0.86),
